...
import com.awesome.amuclient.api.service.GetBowlingListService
...
import kotlinx.android.synthetic.main.fragment_bowling.view.*
...
class BowlingFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.bowling_list.setOnItemClickListener { parent, view, position, id ->
    ...
    override fun onCreateView(
        ...
        val joinApi = retrofit.create(GetBowlingListService::class.java)



        joinApi.getBowlingList(lat.toString(),lng.toString())
            .enqueue(object : Callback<StoreListResponse> {
                ...
                override fun onResponse(
                    ...
                    if (response.isSuccessful && response.body() != null && response.body()!!.code == 200) {
                        ...
                        bowling_list.adapter = storeListAdapter
                    } else {
