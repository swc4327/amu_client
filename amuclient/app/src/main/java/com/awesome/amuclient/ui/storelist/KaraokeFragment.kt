...
import com.awesome.amuclient.api.service.GetKaraokeListService
...
class KaraokeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.karaoke_list.setOnItemClickListener { parent, view, position, id ->
    ...
    override fun onCreateView(
        ...
        val joinApi = retrofit.create(GetKaraokeListService::class.java)



        joinApi.getKaraokeList(lat.toString(),lng.toString())
            .enqueue(object : Callback<StoreListResponse> {
                ...
                override fun onResponse(
                    ...
                    if (response.isSuccessful && response.body() != null && response.body()!!.code == 200) {
                        ...
                        karaoke_list.adapter = storeListAdapter
                    } else {
