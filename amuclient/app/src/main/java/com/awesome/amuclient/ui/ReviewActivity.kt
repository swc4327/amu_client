...
class ReviewActivity : AppCompatActivity() {
    ...
    private fun addReview() {
        ...
        var task = FirebaseStorage.getInstance().getReference()
                .child(FirebaseUtils.getUid() + storeName + "_review")
                ...
                .addOnSuccessListener {
                    ...
                    task.downloadUrl.addOnCompleteListener { task ->
                        val review: Review = Review(null, task.result.toString(),
                                review_comment.text.toString(), null, storeId, FirebaseUtils.getUid(), rbPoint.text.toString(), reserveId)
    ...
    private fun pickImageFromGallery() {
        ...
        startActivityForResult(intent,
            ReviewActivity.IMAGE_PICK_CODE
        )
    }

    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<out String>, grantResults: IntArray) {
        when(requestCode){
            ReviewActivity.PERMISSION_CODE -> {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == Activity.RESULT_OK && requestCode == ReviewActivity.IMAGE_PICK_CODE){
